...
_start:
	movi r4, 0
	movi r10, 0 #reassign r4
	
	movi r5, 0
	movi r11, 0 #reassign r5
	
	movi r12, 17 #max num to display 
	movi r13, 6 #max num hex display (ex hex0 - hex5) 
...
loop:
	...
	addi r10, r10, 1 #r4 + 1 each loop 
	bge r10, r12, change_display #r10 reach max 16, go to next display 
	br loop

change_display:
	movi r10, 0
	addi r11, r11, 1 #r5 + 1, next display 
	bge r11, r13, endloop 
	br loop
